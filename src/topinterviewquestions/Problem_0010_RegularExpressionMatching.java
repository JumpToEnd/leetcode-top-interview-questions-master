...
public class Problem_0010_RegularExpressionMatching {
     ...
     * 1. si == str.length
     *    a. pattern也用完了 => true
     *    b. pi+1 没越界，并且pattern[pi+1] == '*'， 那么认为* 为0次， => process(si, pi+2)
     *    c. 其他情况 => false
     * 2. pi == pattern.length
     *    a. str也用完了 => true
     *    b. 其他情况 => false
     *
     * 对于普遍位置，对于si和pi的位置进行分析：
     * 1. pi + 1 越界了 或者 pattern[pi + 1] 不是 '*' ，说明只能对比 当前位置
     *    a. str[si] == pattern[pi] 或者 pattern[pi] == '.'   =>  process(si + 1, pi + 1)
     *
     * 2. pi + 1 肯定没越界， 并且
     *
     *
